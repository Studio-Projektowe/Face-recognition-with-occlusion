...
# Pliki wyjściowe
FAISS_INDEX_FILE = "gallery_res50.index"
FAISS_MAPPING_FILE = "gallery_res50_map.json"
RESULTS_CSV = "results_res50_occlusion.csv"
...
def initialize_model():
    print("Ładowanie modelu CBAM IResNet50...")
...
def discover_file_structure(local_root):
    ...
    for jpg_path in tqdm(all_files, desc="Indeksowanie plików"):
        ...
        # Kluczem jest folder z obrazkiem (bo tam jest para jpg+json)
        # Zakładamy 1 zdjęcie na folder lub grupujemy je. 
        # W Twoim datasecie CASIA często jest 1 folder = 1 sesja.
        # Żeby nie nadpisywać, użyjmy pełnej ścieżki do jpg jako klucza w mapie par,
        # ALE logika z poprzedniego skryptu grupuje po folderach. Zostańmy przy tym.

...
MODEL_PATH = 'best_model_merged.pth'
...
RESULTS_CSV = os.path.join(METRICS_DIR, 'evaluation_results_stage2.csv')
...
def run_occlusion_evaluation(model, identity_to_imgfolders, image_pairs):
    ...
    with open(RESULTS_CSV, 'w', newline='', encoding='utf-8') as f:
        writer = csv.writer(f)
        writer.writerow(["query_id", "top1_id", "sim", "is_correct"])
        ...
        for id_path in tqdm(identity_paths, desc="Test Okluzji"):
            ...
            for img_folder_path in query_folders:
                ...
                # Zapis podglądu (opcjonalnie, co 100 zdjęcie żeby nie zapchać dysku)
                ...
                D, I = index.search(query_vector, 1) # Tylko Top-1 nas interesuje najbardziej
                ...
                writer.writerow([ground_truth_id, top1_id, f"{top1_sim:.4f}", is_correct])
    ...
    if total_queries > 0:
        ...
        print(f"Poprawne (Rank-1): {correct_top1}")
...
def main():
    ...
    # 4. Testowanie (Zdjęcia z okluzją)

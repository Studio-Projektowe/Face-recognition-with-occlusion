...
🛠️ Rozwiązanie: Custom Loader (loader_check.py)
...
train_project.py (Główna pętla)
loader_check.py (Magiczny loader)
backbone_iresnet.py lub iresnet.py (Definicja architektury)
w600k_r50_from_onnx.pth (Wagi z onnx)
Przygotuj dane w strukturze ImageFolder:
twoje_dane/
└── train/
    ├── osoba_A/
    │   ├── img1.jpg

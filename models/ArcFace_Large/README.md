...
## Model tested
**ArcFace Large (buffalo_l)** from InsightFace — a ResNet50-based ArcFace model trained on MS1MV2 (~5.8M images). It is the heavyweight baseline optimized for high accuracy.

...
if __name__ == "__main__":
    visualize_faiss_index(
        index_file="../Model_B/train_cbam_after_3_layer/metrics_cbam/my_model.index", 
        map_file="../Model_B/train_cbam_after_3_layer/metrics_cbam/my_model_mapping.json", 
        output_image="../Model_B/train_cbam_after_3_layer/metrics_cbam/gallery_visualization_colored.png" # Zmieniona nazwa pliku wyjściowego
    )
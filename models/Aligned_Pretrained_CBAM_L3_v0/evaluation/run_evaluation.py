...
def load_model():
    ...
    for k, v in checkpoint.items():
        ...
        if "cbam" in name and "fc" in name and "weight" in name:
            if v.dim() == 2:
    ...
    print("-" * 50)
    if any("cbam_layer" in k for k in new_state.keys()) and len([k for k in missing if "cbam" in k]) == 0:
        print("SUKCES: Wagi CBAM (256ch) załadowane i dopasowane wymiarami.")
    else:
        print("OSTRZEŻENIE: Sprawdź wagi CBAM.")

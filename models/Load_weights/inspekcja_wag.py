...
def inspect_pth(file_path, save_path):
    ...
    if isinstance(checkpoint, dict):
        ...
        if 'state_dict' in checkpoint:
            print("Znaleziono klucz 'state_dict' - wchodzę głębiej.")
            state_dict = checkpoint['state_dict']
        elif 'model' in checkpoint:
            print("Znaleziono klucz 'model' - wchodzę głębiej.")
            state_dict = checkpoint['model']
        else:
            print("Plik wygląda na płaski słownik wag (state_dict).")
            state_dict = checkpoint
    else:
        print("Plik nie jest słownikiem! To może być cały model (niezalecane).")
